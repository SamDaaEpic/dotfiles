...
local color = require("conf.theme.colors")
local dpi = require("beautiful").xresources.apply_dpi
local gears = require("gears")
local wibox = require("wibox")
-- Icon directory path
local icondir = awful.util.getdir("config") .. "conf/icons/audio/"
...
return function(s)
  ...
  local get_volume = function()
    awful.spawn.easy_async_with_shell(
      "./.config/awesome/bin/vol.sh volume",
      function(stdout)
      ...
      audio_widget.container.audio_layout.icon_margin.icon_layout.icon:set_image(gears.color.recolor_image(icon .. ".svg", "#000"))
  ...
  local check_muted = function()
    awful.spawn.easy_async_with_shell(
      ...
      if stdout:match("yes") then
        ...
        audio_widget.container.audio_layout.icon_margin.icon_layout.icon:set_image(gears.color.recolor_image(icondir .. "volume-mute" .. ".svg", "#000000"))
  ...
  -- Signals
  Hover_signal(audio_widget, "#85EA6D")
